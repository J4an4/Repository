...
AppStatus Game::LoadResources()
{
    ...
    if (data.LoadTexture(Resource::IMG_MENU, "images/menuuu.png") != AppStatus::OK)
    {
        return AppStatus::ERROR;
    }
...
{
    scene = new Scene();
    soundMusic[1] = LoadMusicStream("sound/title_screen.ogg");
...
{
    scene = new Scene();
    soundMusic[0] = LoadMusicStream("sound/music.ogg");
...
{//Check if user attempts to close the window, either by clicking the close button or by pressing Alt+F4
    ...
    case GameState::MAIN_MENU:
        ...
        if (IsKeyPressed(KEY_SPACE) or (IsKeyPressed(KEY_R) and state == GameState::PLAYING))
        {
            ...
            soundEffect[0] = LoadSound("sound/transition.wav");
    ...
    case GameState::PLAYING:
        ...
        {
            StopMusicStream(soundMusic[0]);
            soundMusic[3] = LoadMusicStream("sound/failure.ogg");
        ...
        {
            StopMusicStream(soundMusic[0]);
            soundMusic[2] = LoadMusicStream("sound/stage_complete.ogg");
